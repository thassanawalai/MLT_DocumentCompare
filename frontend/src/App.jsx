...
const translations = {
  th: {
    ...
    originalDocument: 'Bill of Lading (B/L)', originalDescription: 'นำเข้าเอกสารที่นี่',
    programDocument: 'Shipping Instruction', programDescription: 'นำเข้าเอกสารที่นี่', template: 'รูปแบบเอกสาร:',
    uploadRequired: 'กรุณาอัปโหลดเอกสารให้ครบทั้ง 2 ฝั่ง', comparing: 'กำลังเปรียบเทียบเอกสาร...', compare: 'เปรียบเทียบข้อมูล',
    ...
    originalPane: 'Bill of Lading (B/L) (ซ้าย)', programPane: 'Shipping Instruction (ขวา)',
    ...
    originalData: 'Bill of Lading (B/L) (ซ้าย)', programData: 'Shipping Instruction (ขวา)', allMatch: 'ยอดเยี่ยม! ข้อมูลตรงกันทุกจุด',
    howToUse: 'วิธีใช้: อัปโหลดเอกสารสองฉบับ เลือกเทมเพลตที่ถูกต้อง แล้วคลิก "เปรียบเทียบ" เพื่อดูความแตกต่าง',
  },
  en: {
    language: 'Language', verification: 'MLT Verification', heading: 'Document Comparison System', subheading: 'A document verification tool for MARITIME ALLIANCES.',
    originalDocument: 'Bill of Lading (B/L)', originalDescription: 'Upload your file here',
    programDocument: 'Shipping Instruction', programDescription: 'Upload your file here', template: 'Template:',
    uploadRequired: 'Please upload both documents.', comparing: 'Comparing documents...', compare: 'Compare Data',
    ...
    originalPane: 'Bill of Lading (B/L) (Left)', programPane: 'Shipping Instruction (Right)',
    ...
    field: 'Field', originalColumn: 'Bill of Lading (B/L) (Left)', programColumn: 'Shipping Instruction (Right)', noData: '(Not found)',
    errorList: 'Discrepancy List', discrepanciesFound: 'discrepancies found', points: '', fieldName: 'Field Name',
    originalData: 'Bill of Lading (B/L) (Left)', programData: 'Shipping Instruction (Right)', allMatch: 'Excellent! All data points match.',
...
function App() {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '100vh', maxWidth: '1500px', margin: '0 auto', padding: '0 24px' }}>
        <main>
          <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: '40px 0 36px', flexWrap: 'wrap', gap: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              ...
              <div>
                ...
                <p style={{ color: theme.inkSoft, fontSize: '1.0em', marginTop: '4px', textAlign: 'left', marginBlock: 0 }}>
                  {copy.subheading}
                </p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px', color: theme.inkSoft, fontSize: '0.85em', fontWeight: 700 }}>
          ...
          {results && (
            <>
              ...
              <div style={{
                marginTop: '32px',
                padding: '24px',
                border: `1px solid ${results.discrepancies.length > 0 ? '#fecaca' : theme.border}`,
                borderRadius: '16px',
                backgroundColor: theme.surface,
                boxShadow: theme.shadow,
                borderTop: `4px solid ${results.discrepancies.length > 0 ? theme.red : theme.green}`,
              }}>
                <h2 style={{ color: results.discrepancies.length > 0 ? theme.red : theme.green, marginTop: 0, fontSize: '1.4em' }}>
                  {results.discrepancies.length > 0 ? `⚠️ ${copy.errorList}: ${results.discrepancies.length} ${copy.discrepanciesFound}` : `✅ ${copy.allMatch}`}
                </h2>
